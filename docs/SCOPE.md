...
- Web management: live field activity, branch teams and outlets, agent productivity, sales targets, customer and historical order records, SIM inventory and allocation, KYC transaction tracking, compliance review, immutable audit history, CSV/PDF reports.
